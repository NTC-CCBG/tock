...
struct PwmRegisters {
    ...
    _reserved7: [u8; 16],
    psel_out: [VolatileCell<crate::pinmux::Pinmux>; 4],
}
...
impl Pwm {
    ...
    fn stop_pwm(&self, _pin: &crate::pinmux::Pinmux) -> Result<(), ErrorCode> {
