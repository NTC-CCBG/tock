...
// use crate::startup::{UartChannel, UartPins};
...
type AlarmDriver = components::alarm::AlarmDriverComponentType<npcm400::rtc::Rtc<'static>>;
type RngDriver = components::rng::RngComponentType<npcm400::trng::Trng<'static>>;

// TicKV
type Mx25r6435f = components::mx25r6435f::Mx25r6435fComponentType<
    npcm400::spi::SPIM<'static>,
    npcm400::gpio::GPIOPin<'static>,
    npcm400::rtc::Rtc<'static>,
>;
...
type TemperatureDriver =
    components::temperature::TemperatureComponentType<npcm400::temperature::Temp<'static>>;
...
pub struct Platform {
    ble_radio: &'static capsules_extra::ble_advertising_driver::BLE<
        'static,
        npcm400::ble_radio::Radio<'static>,
        VirtualMuxAlarm<'static, npcm400::rtc::Rtc<'static>>,
    >,
    button: &'static capsules_core::button::Button<'static, npcm400::gpio::GPIOPin<'static>>,
    ...
    gpio: &'static capsules_core::gpio::GPIO<'static, npcm400::gpio::GPIOPin<'static>>,
    led: &'static capsules_core::led::LedDriver<
        'static,
        kernel::hil::led::LedLow<'static, npcm400::gpio::GPIOPin<'static>>,
        4,
    >,
    rng: &'static RngDriver,
    adc: &'static capsules_core::adc::AdcDedicated<'static, npcm400::adc::Adc<'static>>,
...
pub unsafe fn start() -> (
    ...
    &'static MuxAlarm<'static, npcm400::rtc::Rtc<'static>>,
) {
    //--------------------------------------------------------------------------
    // INITIAL SETUP
    //--------------------------------------------------------------------------
    ...
    let npcm400_peripherals = static_init!(
        Npcm400DefaultPeripherals,
        Npcm400DefaultPeripherals::new()
    );
    ...
    kernel::debug::assign_gpios(
        Some(&npcm400_peripherals.gpio_port[LED1_PIN]),
        Some(&npcm400_peripherals.gpio_port[LED2_PIN]),
        Some(&npcm400_peripherals.gpio_port[LED3_PIN]),
    );
    ...
    // platforms.
    startup::NrfStartupComponent::new(
        false,
        BUTTON_RST_PIN,
        npcm400::uicr::Regulator0Output::DEFAULT,
        &npcm400_peripherals.nvmc,
    )
    .finalize(());
    ...
    let gpio_port = &npcm400_peripherals.gpio_port;
    ...
    let gpio = components::gpio::GpioComponent::new(
        ...
        components::gpio_component_helper!(
            npcm400::gpio::GPIOPin,
            0 => &npcm400_peripherals.gpio_port[Pin::P1_01],
            1 => &npcm400_peripherals.gpio_port[Pin::P1_02],
            2 => &npcm400_peripherals.gpio_port[Pin::P1_03],
            3 => &npcm400_peripherals.gpio_port[Pin::P1_04],
            4 => &npcm400_peripherals.gpio_port[Pin::P1_05],
            5 => &npcm400_peripherals.gpio_port[Pin::P1_06],
            6 => &npcm400_peripherals.gpio_port[Pin::P1_07],
            7 => &npcm400_peripherals.gpio_port[Pin::P1_08],
            // Avoid exposing the I2C pins to userspace, as these are used in
            // some tutorials (e.g., `npcm400dk-thread-tutorial`).
            //
            // In the future we might want to make this configurable.
            //
            // 8 => &npcm400_peripherals.gpio_port[Pin::P1_10],
            // 9 => &npcm400_peripherals.gpio_port[Pin::P1_11],
            10 => &npcm400_peripherals.gpio_port[Pin::P1_12],
            11 => &npcm400_peripherals.gpio_port[Pin::P1_13],
            12 => &npcm400_peripherals.gpio_port[Pin::P1_14],
            13 => &npcm400_peripherals.gpio_port[Pin::P1_15],
        ),
    )
    .finalize(components::gpio_component_static!(npcm400::gpio::GPIOPin));
    ...
    let button = components::button::ButtonComponent::new(
        ...
        components::button_component_helper!(
            npcm400::gpio::GPIOPin,
            (
                &npcm400_peripherals.gpio_port[BUTTON1_PIN],
                kernel::hil::gpio::ActivationMode::ActiveLow,
                kernel::hil::gpio::FloatingState::PullUp
            ),
            (
                &npcm400_peripherals.gpio_port[BUTTON2_PIN],
                kernel::hil::gpio::ActivationMode::ActiveLow,
                kernel::hil::gpio::FloatingState::PullUp
            ),
            (
                &npcm400_peripherals.gpio_port[BUTTON3_PIN],
                kernel::hil::gpio::ActivationMode::ActiveLow,
                kernel::hil::gpio::FloatingState::PullUp
            ),
            (
                &npcm400_peripherals.gpio_port[BUTTON4_PIN],
                kernel::hil::gpio::ActivationMode::ActiveLow,
                kernel::hil::gpio::FloatingState::PullUp
            )
        ),
    ...
    let led = components::led::LedsComponent::new().finalize(components::led_component_static!(
        LedLow<'static, npcm400::gpio::GPIOPin>,
        LedLow::new(&npcm400_peripherals.gpio_port[LED1_PIN]),
        LedLow::new(&npcm400_peripherals.gpio_port[LED2_PIN]),
        LedLow::new(&npcm400_peripherals.gpio_port[LED3_PIN]),
        LedLow::new(&npcm400_peripherals.gpio_port[LED4_PIN]),
    ));
    ...
    let rtc = &npcm400_peripherals.rtc;
    let _ = rtc.start();
    let mux_alarm = components::alarm::AlarmMuxComponent::new(rtc)
        .finalize(components::alarm_mux_component_static!(npcm400::rtc::Rtc));
    let alarm = components::alarm::AlarmDriverComponent::new(
        board_kernel,
        capsules_core::alarm::DRIVER_NUM,
        mux_alarm,
    )
    .finalize(components::alarm_component_static!(npcm400::rtc::Rtc));

    //--------------------------------------------------------------------------
    // UART & CONSOLE & DEBUG
    //--------------------------------------------------------------------------

    let uart_channel = UartChannelComponent::new(
        uart_channel,
        mux_alarm,
        &npcm400_peripherals.uarte0,
    )
    .finalize(uart_channel_component_static!(
        npcm400::rtc::Rtc
    ));
    ...
    let ble_radio = components::ble::BLEComponent::new(
        ...
        &npcm400_peripherals.ble_radio,
        mux_alarm,
    )
    .finalize(components::ble_component_static!(
        npcm400::rtc::Rtc,
        npcm400::ble_radio::Radio
    ));
    ...
    let temp = components::temperature::TemperatureComponent::new(
        ...
        &npcm400_peripherals.temp,
    )
    .finalize(components::temperature_component_static!(
        npcm400::temperature::Temp
    ));
    ...
    let rng = components::rng::RngComponent::new(
        ...
        &npcm400_peripherals.trng,
    )
    .finalize(components::rng_component_static!(npcm400::trng::Trng));
    ...
    let adc_channels = static_init!(
        [npcm400::adc::AdcChannelSetup; 6],
        [
            npcm400::adc::AdcChannelSetup::new(npcm400::adc::AdcChannel::AnalogInput1),
            npcm400::adc::AdcChannelSetup::new(npcm400::adc::AdcChannel::AnalogInput2),
            npcm400::adc::AdcChannelSetup::new(npcm400::adc::AdcChannel::AnalogInput4),
            npcm400::adc::AdcChannelSetup::new(npcm400::adc::AdcChannel::AnalogInput5),
            npcm400::adc::AdcChannelSetup::new(npcm400::adc::AdcChannel::AnalogInput6),
            npcm400::adc::AdcChannelSetup::new(npcm400::adc::AdcChannel::AnalogInput7),
        ]
    );
    let adc = components::adc::AdcDedicatedComponent::new(
        &npcm400_peripherals.adc,
        adc_channels,
        board_kernel,
    ...
    let mux_spi = components::spi::SpiMuxComponent::new(&npcm400_peripherals.spim0)
        .finalize(components::spi_mux_component_static!(npcm400::spi::SPIM));
    ...
    npcm400_peripherals.spim0.configure(
        npcm400::pinmux::Pinmux::new(SPI_MOSI as u32),
        npcm400::pinmux::Pinmux::new(SPI_MISO as u32),
        npcm400::pinmux::Pinmux::new(SPI_CLK as u32),
    );
    ...
    let i2c_master_slave = components::i2c::I2CMasterSlaveDriverComponent::new(
        ...
        &npcm400_peripherals.twi1,
    )
    .finalize(components::i2c_master_slave_component_static!(
        npcm400::i2c::TWI
    ));

    npcm400_peripherals.twi1.configure(
        npcm400::pinmux::Pinmux::new(I2C_SCL_PIN as u32),
        npcm400::pinmux::Pinmux::new(I2C_SDA_PIN as u32),
    );
    npcm400_peripherals.twi1.set_speed(npcm400::i2c::Speed::K400);
    ...
    NrfClockComponent::new(&npcm400_peripherals.clock).finalize(());
    ...
    //     &npcm400_peripherals.usbd,
    //     0x1915, // Nordic Semiconductor
    //     0x503a, // lowRISC generic FS USB
    //     strings,
    // )
    // .finalize(components::ctap_component_static!(npcm400::usbd::Usbd));

    // ctap.enable();
    // ctap.attach();

    // // Keyboard HID Example
    // type UsbHw = npcm400::usbd::Usbd<'static>;
    // let usb_device = &npcm400_peripherals.usbd;
    ...
    npcm400_peripherals.adc.calibrate();
